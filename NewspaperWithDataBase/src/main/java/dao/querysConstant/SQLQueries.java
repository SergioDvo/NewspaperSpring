...
public class SQLQueries {
    ...
    public static final String QUERY_4 = "SELECT a.id," +
            "       a.name_article," +
            "       a.id_newspaper," +
            "       r.ranking," +
            "       (SELECT COUNT(*)" +
            ...
            "          AND ranking < 5) AS bad_ratings" +
            " FROM article a" +
            "    LEFT JOIN readarticle r" +
    ...
    public static final String SELECT_READERS_FROM_LOGIN = "select id_reader from login where user = ? and password = ?";
